...
def interp(x,I,phii,**kwargs):
    ...
    out = grid_sample(I[None],phii.permute((1,2,0))[None],align_corners=True,**kwargs)
...
smile1_file = 'smile2.png'
image1 = plt.imread(smile1_file)
fig,ax = plt.subplots()
ax.imshow(image1)
plt.show()

smile2_file = 'smile1.png'
image2 = plt.imread(smile2_file)
fig,ax = plt.subplots()
ax.imshow(image2)
plt.show()
...
dtype = torch.float64
device = 'cpu'
I = torch.as_tensor(image1,dtype=dtype,device=device) 
J = torch.as_tensor(image2,dtype=dtype,device=device) 
I.shape
J.shape
...
pointsI = np.array([[100,150], [150,150], [200,150]])
pointsJ = np.array([[100,150], [150,150], [200,150]])
